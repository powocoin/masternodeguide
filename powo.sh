...
powocoin-cli stop > /dev/null 2>&1
wget https://github.com/powocoin/powocoin/releases/download/v1.0.0/powocoin-1.0.0-x86_64-linux-gnu.tar.gz
tar -xvzf powocoin-1.0.0-x86_64-linux-gnu.tar.gz
mv powocoin-1.0.0/bin/powocoind -O /usr/local/bin/powocoind
mv powocoin-1.0.0/bin/powocoin-cli -O /usr/local/bin/powocoin-cli
chmod +x /usr/local/bin/powocoin*
...
echo "rpcport=31616" >> $CONF_DIR/$CONF_FILE
