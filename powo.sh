...
CONFIG_FILE='powocoin.conf'
CONFIGFOLDER='/root/.powocoin'
COIN_DAEMON='/usr/local/bin/powocoind'
COIN_CLI='/usr/local/bin/powocoin-cli'
COIN_REPO='https://github.com/powocoin/powocoin/releases/download/v1.0.0/powocoin-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_NAME='PowoCoin'
COIN_PORT=18882
